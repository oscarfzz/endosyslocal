...
//		'<li id="menu-principal-citaspendientes"><a href="#"><span class="endo-icon ui-icon" />%s</a></li>' +/*IDIOMAOK*/
		'<li id="menu-principal-citaspendientes"><span class="endo-icon ui-icon" />%s</li>' +/*IDIOMAOK*/
		'<li id="menu-principal-nuevaexpl"><span class="endo-icon ui-icon" />%s</li>' +/*IDIOMAOK*/

		'<li id="menu-principal-buscarexpl"><span class="endo-icon ui-icon" />%s' +/*IDIOMAOK*/
			'<ul>' +
			'<li id="menu-principal-buscarexpl-fecha"><span class="endo-icon ui-icon" />%s</li>' +/*IDIOMAOK*/
			'<li id="menu-principal-buscarexpl-paciente"><span class="endo-icon ui-icon" />%s</li>' +/*IDIOMAOK*/
			'<li id="menu-principal-buscarexpl-nexpl"><span class="endo-icon ui-icon" />%s</li>' +/*IDIOMAOK*/
			'<li id="menu-principal-buscarexpl-sinfinalizar"><span class="endo-icon ui-icon" />%s</li>' +/*IDIOMAOK*/
			'<li id="menu-principal-buscarexpl-avanzadas"><span class="endo-icon ui-icon" />%s' +/*IDIOMAOK*/
				'<ul>' +
				'<li id="menu-principal-nuevabusqueda"><span class="endo-icon ui-icon" />%s</li>' +/*IDIOMAOK*/
				'<li id="menu-principal-busquedas"><span class="endo-icon ui-icon" />%s</li>' +/*IDIOMAOK*/
				'<li>-</li>' +
				'</ul>' +
			'</li>' +
			'</ul>' +
		...
		'<li id="menu-principal-gestioncitas"><span class="endo-icon ui-icon endo-icon-gestioncitas" />%s</li>' +/*IDIOMAOK*/
		'<li id="menu-principal-gestionpacientes"><span class="endo-icon ui-icon" />%s</li>' +/*IDIOMAOK*/

		'<li id="menu-principal-group-administracion"><span class="endo-icon ui-icon" />%s' +/*IDIOMAOK*/
			'<ul>' +
			...
			'<li id="menu-principal-mensaje"><span class="endo-icon ui-icon" />%s</li>' +/*IDIOMAOK*/
			'</ul>' +
		'</li>' +
