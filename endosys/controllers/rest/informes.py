...
from endosys.model.informes import Informe, Rel_Capturas_Informes
...
from endosys.model.servicios import get_servicio_id
from endosys.model.servicios import Servicio
from endosys.lib.base import render
from endosys.lib.genericREST import *
from endosys.lib.formularios import FormExplData
from endosys.lib.informes import generar_informe, previsualizar_para_firmar, get_pdf, guardar_pdf_en_carpeta, nombre_archivo_informe
from endosys.lib.plugins.base import *
from endosys.config.plugins import pluginInformes
import endosys.lib.registro as registro
from endosys.lib.exploraciones import is_exploracion_borrada
from endosys.lib.capturas import obtener_del_pacs, _archivo
            ...
            if nuevoInforme.tipo < 10:
                ...
                if config.get('ENVIAR_ORU.ACTIVO', '0') == '1':
                    ...
                    if config.get('ENVIAR_ORU.INCRUSTADO', '0') == '1':
                        ...
                        enviado_informe = endosys.lib.hl7_wrapper.sending.enviar_ORU_R01(nuevoInforme, True, True)
                        ...
                        if algun_informe_enviado == False:
                            enviado_informe = endosys.lib.hl7_wrapper.sending.enviar_ORU_R01(nuevoInforme)
                    else:
                        # enviar siempre
                        enviado_informe = endosys.lib.hl7_wrapper.sending.enviar_ORU_R01(nuevoInforme, True)
    ...
    def delete(self, id):
        ...
        if 'borrado_motivo' in request.params and request.params["borrado_motivo"].strip()!="":
            ...
            if config.get('ENVIAR_ORU.ACTIVO', '0') == '1' and config.get('ENVIAR_ORU.ANULAR', '0') == '1':
                ...
                enviado_informe = False
                from  endosys.lib.hl7_wrapper.sending import enviar_ORU_R01
