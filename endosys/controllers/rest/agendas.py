...
from endosys.model.salas import Rel_Salas_Agendas
from endosys.model.medicos import Rel_Medicos_Agendas
from endosys.model.usuarios import get_usuario
from endosys.lib.genericREST import GenericRESTController
from endosys.lib.usuarios.seguridad import roles
from endosys.lib.misc import generic_abort, formatea_valor, registro_by_id
...
class AgendasController(GenericRESTController):
	...
	def delete(self, id):
		...
		if agenda is None:
			...
			endosys.lib.organizacion_centros.clear_defaults(agenda_id = agenda.id, commit = False)
