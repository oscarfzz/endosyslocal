...
from endosys.model.salas import Rel_Salas_Servicios
from endosys.model.medicos import Rel_Medicos_Servicios
...
class ServiciosController(GenericRESTController):
	...
	def delete(self, id):
		...
		if servicio is None:
			...
			endosys.lib.organizacion_centros.clear_defaults(servicio_id = servicio.id, commit = False)
