...
from endosys.lib.plugins.base.estudios import PluginEstudios, Estudio
...
import endosys.model.estudios, endosys.model.citas, endosys.model.prestaciones
...
class PluginEstudiosBaixLlobregat(PluginEstudios):
	...
	def __init__(self, campo_endoscopio):
		...
		from endosys.lib.plugins.campos_baixllobregat import PluginCamposBaixLlobregat
	...
	def finaliza_estudio(self, id, medico):
		...
		def get_endoscopio():
			from endosys.lib.prestacion import TIPO_SELEC
			from endosys.lib.prestacion import PrestData
