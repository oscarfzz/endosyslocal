...
from endosys.lib.plugins.base.campos import PluginCampos, Campo, Elemento
...
from endosys.model.estudios import Estudio
...
class PluginCamposBaixLlobregat(PluginCampos):
    ...
    def __init__(self):
        ...
        from endosys.lib.plugins.estudios_baixllobregat import PluginEstudiosBaixLlobregat
    ...
    def _get_TicketsLavadoras_class(self):
        ...
        from endosys.config.plugins import pluginEstudios
    ...
    def get_campos(self, prestacion):
        from endosys.lib.prestacion import TIPO_SELEC, TIPO_MEMO
