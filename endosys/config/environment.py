...
import endosys.lib.app_globals as app_globals
import endosys.lib.helpers
...
def load_environment(global_conf, app_conf):
    ...
    config['pylons.h'] = endosys.lib.helpers
    ...
    from endosys.lib.chunks.utils import comenzar_hilo_chunks
    ...
    from endosys.lib.purgadoImagenes.utils import comenzar_hilo_purgado
