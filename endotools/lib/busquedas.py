...
from endotools.model.formularios import Formulario
...
import endotools.model.busquedas
...
import endotools.lib.elementos
...
def ejecutar_busqueda(busqueda, query):
	...
	if isint(busqueda):
		busqueda_reg = registro_by_id(endotools.model.busquedas.Busqueda, busqueda)
		if busqueda_reg:
