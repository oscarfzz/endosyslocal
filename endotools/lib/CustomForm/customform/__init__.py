##Este metodo es una copia del form normal, pero manteniendo una lista de los usuarios
##autenticados para poder controlar que solo se pueda autenticar 1 vez simultaneamente cada usuario
##Usar este metodo junto al customcookie, que controla el signout
...
from endotools.lib.usuarios.conexiones import intentar_conexion

import logging
log = logging.getLogger('authkit.authenticate.customform')
...
class CustomFormAuthHandler(AuthKitAuthHandler, AuthFormHandler):
    def __init__(
        self,
        app,
        charset=None,
        ...
        if 'POST' == environ['REQUEST_METHOD']:
            ...
            if username and password:
                if self.authfunc(environ, username, password):
                    if intentar_conexion(username):
                        environ['AUTH_TYPE'] = 'customform'
...
def load_form_config(
    ...
    app_conf=None,
    global_conf=None,
    prefix='authkit.method.customform',
):
