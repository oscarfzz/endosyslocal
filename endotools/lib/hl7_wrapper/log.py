...
def nuevo_log_HL7(hl7Process):
    ...
    if hl7Process.message_type == 'SIU':
        ...
        numero_cita = endotools.lib.hl7_wrapper.hl7val(sch.get(1.1))
        numero_peticion = endotools.lib.hl7_wrapper.hl7val(sch.get(26.1))

    #SI ES ORM
    if hl7Process.message_type == 'ORM':
        orc = hl7Process.msg.segment('ORC')
        numero_peticion = endotools.lib.hl7_wrapper.hl7val(orc.get(2.1))
