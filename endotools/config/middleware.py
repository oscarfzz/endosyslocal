...
def make_app(global_conf, full_stack=True, **app_conf):
    ...
    if asbool(full_stack):
        ...
        # XXX   #################################
        from endotools.lib.middleware.error import EndoTools_ErrorHandler
        ...
        # authkit
        import endotools.lib.usuarios.LDAPauthentication
        if int(config.get('USAR_LDAP', '0')):
            print "Usando autenticacion LDAP"

        authkit.authenticate.valid_password = endotools.lib.usuarios.LDAPauthentication.valid_password
