...
from endotools.lib.db import nombre_tabla, nueva_columna, existe_columna
...
class DbupdateController(BaseController):
    ...
    def _update_prioridad(self):
        ...
        """
        from endotools.model import Prioridad
    ...
    def _update_valor_tipo_usuario(self):
        ...
        el tipo 1.
        '''
        from endotools.model import Usuario, Medico
    ...
    def _reasignar_servicios(self):
        ...
        from endotools.model import Servicio
        from endotools.model.tiposExploracion import TipoExploracion,Rel_Servicios_TiposExploracion
